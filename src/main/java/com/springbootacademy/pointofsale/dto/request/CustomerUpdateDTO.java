...
//request pckge is not necessary, for standards use it
//This DTO create the Customer updatable fields only - active status and nic are not updatable in real-world
